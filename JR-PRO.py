...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mJOHIRUL ISLAM
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801775271320
\x1b[93;1m FACEBOOK       \x1b[92;1m=>      \x1b[93;1mJOHIRUL ISLAM
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/profile.php?id=100024905865458")
		exit()
	else:
		os.system("https://www.facebook.com/profile.php?id=100024905865458")
		exit()
...
def setting():
	...
	if fast in ['y','Y']:
		...
		os.system("xdg-open https://youtu.be/dYceWjbeXik")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [ JR-PRO ] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [ JR-PRO-CP ] %s|%s        '%(b,idf,pw))
